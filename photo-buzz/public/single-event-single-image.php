...
?>
<div class="content e-flex e-con-boxed e-con e-parent" <?php if (is_photolead()) echo ' style="display: flex"'; ?>>
            ...
            ?><div class="single-image-view-box">
                ...
                if ($terms && (in_array("photoset", $terms))) {
                    ...
                    if (can_delete_image(get_the_ID())) {
                        ...
                        $result = pb_handle_frontend_ai_form_submission($cmb, get_the_ID());
                        if ($result) {

                            if (is_wp_error($result)) {

                                // If there was an error with the submission, add it to our ouput.
                                echo '<div class="callout alert">' . sprintf(__('Fehler: %s', 'wds-post-submit'), '<strong>' . $result->get_error_message() . '</strong>') . '</div>';
                            } else {

                                echo '<div class="callout success">Deine Änderungen wurden gespeichert.</div>';
                            }
                        }

                        echo cmb2_get_metabox_form($cmb, $object_id, array('save_button' => "Hochladen"));
                    }
                ?>
                    <div class="gallery">
                        <div class="img-container photoset gallery-grid masonry-grid masonry">
